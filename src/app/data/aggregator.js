...
var findClosestExample = (examples, transaction, threshold = 40) => examples
    .map(example => ({
        example,
...
module.exports = function (resultsConsumer) {


    require('../load/transactions')(transactions => resultsConsumer(transactions.map(transaction => {
            ...
            console.log("Matched "+transaction.name+" to "+closestExample.example.name+": "+closestExample.similarity+"%")
